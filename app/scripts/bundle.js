...
var Quill = React.createClass({displayName: "Quill",
	...
	render: function() {
		return (
			...
			React.createElement(TranscriptContainer, {data: this.state.data})
			)
			);
	},
...
var TranscriptContainer = React.createClass({displayName: "TranscriptContainer",
	render: function () {
		console.log('from TranscriptContainer state ',this.props.data);
		var transcriptions = this.props.data.map(function (t) {
			return (
				React.createElement(Transcript, {author: t.author, text: t.text}
				)
				);
		});
		return (
			React.createElement("div", {className: "transcriptContainer"}, 
			transcriptions
			)
			);
	}
...
var Transcript = React.createClass({displayName: "Transcript",
	render: function () {
		return (
			React.createElement("div", {className: "transcript"}, 
			React.createElement("b", null, this.props.author), " :", 
			this.props.text
			)
			);
	}
...
var PeerVideoContainer = React.createClass({displayName: "PeerVideoContainer",
	render: function () {
		var peerVids = this.props.data.map(function (p) {
			return (React.createElement(PeerVideo, {peerID: p.peerID, src: p.stream}
				));
		});
		return (
			React.createElement("div", {className: "peerVideoContainer"}, 
			peerVids
			)
			);
	}
...
var PeerVideo = React.createClass({displayName: "PeerVideo",
	render: function () {
		stream = window.URL.createObjectURL(this.props.src);

		return (
			React.createElement("div", {className: "PeerVideo"}, 
			React.createElement("video", {id: this.props.peerID, src: stream, autoplay: true}), 
			React.createElement("button", {id: peerID}, " Hang Up ")
			)
			);
	}
});

React.render(React.createElement(Quill, {data: data}), document.getElementById('content'));
...
},{"./transcribe":2,"jquery":3,"react":158}],2:[function(require,module,exports){
